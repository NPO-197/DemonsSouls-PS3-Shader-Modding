...
export WitchyBND := ./Tools/proton Tools/WitchyBND/WitchyBND.exe
...
export DeS_USRDIR := /home/keithziss/.config/rpcs3/dev_hdd0/game/NPUB30910/USRDIR
#Command to launch RPCS3, ie <path to rpcs3 executable>
export RPCS3 := /home/keithziss/Documents/DesktopPrograms/rpcs3-v0.0.37-17995-d6853486_linux64.AppImage

ShaderSourceFile = DS_Fil_Dof.cg
